import Task1.Bottles;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class BottlesTest {
    @Test
    public void Test_FirstVerse()
    {
    ...
    @Test
    public void Test_WrongVerse()
    {
        Bottles bottles = new Bottles();
        assertEquals(null,bottles.verse(150));
    }

    @Test
    public void Test_Penultimate_Penultimate_Verse()
    {
        Bottles bottles = new Bottles();
    ...
    @Test
    public void Test_Penultimate_Verse()
    {
        Bottles bottles = new Bottles();
    ...
    @Test
    public void Test_Last_Three_Verses()
    {
        Bottles bottles = new Bottles();
        String expected = "2 bottles of beer on the wall, 2 bottles of beer.\n" +
                "Take one down and pass it around, 1 bottle of beer on the wall.\n" +
